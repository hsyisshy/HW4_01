...
@section('content')
    <div class="profile-container">
        ...
        <div id="delete-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[20]">
